...
3. **Serviços** — os materiais só documentam **um** serviço (pulverização/aplicação agrícola de precisão com drone). A seção "Serviços" já está pronta para receber mais itens: edite o array em `lib/site-data.ts`.
